...
*   Utility functions (e.g., [`src/utils/security.js`](src/utils/security.js), [`src/utils/validation.js`](src/utils/validation.js)).
*   Service modules (e.g., [`src/services/auth.service.js`](src/services/auth.service.js), [`src/services/report.service.js`](src/services/report.service.js)).
*   Complex UI components (if any are developed as reusable components).
...
**Scope and Priorities:**
*   Interaction between UI controllers and services (e.g., does [`form.controller.js`](src/landing-page/form.controller.js) call the `report.service.js` with the correct data?).
