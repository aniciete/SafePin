    ...
    <section className="bg-gray-50 dark:bg-neutral-900 py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step) => (
            <div key={step.number} className="text-center p-6 rounded-lg bg-white dark:bg-neutral-800 shadow-md">
              <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-primary rounded-full text-white text-2xl font-bold">
                {step.number}
              </div>
