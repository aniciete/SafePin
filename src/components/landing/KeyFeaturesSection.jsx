  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center text-gray-800 dark:text-white mb-12">Key Features</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          <div className="p-8 bg-white dark:bg-neutral-800 rounded-lg shadow-lg">
            <div className="mb-4">
            ...
            <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Anonymous Reporting</h3>
          ...
          <div className="p-8 bg-white dark:bg-neutral-800 rounded-lg shadow-lg">
            ...
            <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Real-Time Alerts</h3>
            <p className="text-gray-600 dark:text-neutral-300">
          ...
          <div className="p-8 bg-white dark:bg-neutral-800 rounded-lg shadow-lg">
            ...
            <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Community-Driven</h3>
            <p className="text-gray-600 dark:text-neutral-300">
