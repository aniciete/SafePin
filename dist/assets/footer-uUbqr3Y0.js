var r=(a,e)=>()=>(e||a((e={exports:{}}).exports,e),e.exports);var o=r((s,t)=>{class n{constructor(){this.currentPage=this.getCurrentPage()}getCurrentPage(){const e=window.location.pathname;return e.includes("index.html")||e==="/"||e===""?"home":e.includes("about-us.html")?"about":e.includes("features.html")?"features":e.includes("faq.html")?"faq":e.includes("report.html")?"report":e.includes("verification.html")?"verification":"home"}generateHeader(){return`
        ...
        `}getHomeLink(){return window.location.pathname.includes("landing-page/")?"../index.html":"index.html"}getLogoPath(){return window.location.pathname.includes("landing-page/")?"../landing-page/SafePin Logo Green.svg":"landing-page/SafePin Logo Green.svg"}getAboutLink(){return window.location.pathname.includes("landing-page/")?"about-us.html":"landing-page/about-us.html"}getFeaturesLink(){return window.location.pathname.includes("landing-page/")?"features.html":"landing-page/features.html"}getFaqLink(){return window.location.pathname.includes("landing-page/")?"faq.html":"landing-page/faq.html"}getLoginLink(){return window.location.pathname.includes("landing-page/")?"../login.html":"login.html"}insertHeader(){const e=document.getElementById("header-container");e?e.innerHTML=this.generateHeader():console.warn('Header container not found. Add <div id="header-container"></div> to your page.')}init(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{this.insertHeader()}):this.insertHeader()}}typeof t<"u"&&t.exports&&(t.exports=n);typeof window<"u"&&new n().init();class i{constructor(){this.currentYear=new Date().getFullYear()}generateFooter(){return`
            <footer>
        ...
        `}getAboutLink(){return window.location.pathname.includes("landing-page/")?"about-us.html":"landing-page/about-us.html"}getFaqLink(){return window.location.pathname.includes("landing-page/")?"faq.html":"landing-page/faq.html"}insertFooter(){const e=document.getElementById("footer-container");e?e.innerHTML=this.generateFooter():console.warn('Footer container not found. Add <div id="footer-container"></div> to your page.')}init(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{this.insertFooter()}):this.insertFooter()}}typeof t<"u"&&t.exports&&(t.exports=i);typeof window<"u"&&new i().init()});export default o();
