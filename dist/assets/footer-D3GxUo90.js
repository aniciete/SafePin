class n{constructor(){this.currentPage=this.getCurrentPage()}getCurrentPage(){const e=window.location.pathname;return e.includes("index.html")||e==="/"||e===""?"home":e.includes("about-us.html")?"about":e.includes("features.html")?"features":e.includes("faq.html")?"faq":e.includes("report.html")?"report":e.includes("verification.html")?"verification":"home"}generateHeader(){return`
        ...
        `}getAboutLink(){return window.location.pathname.includes("landing-page/")?"about-us.html":"landing-page/about-us.html"}getFaqLink(){return window.location.pathname.includes("landing-page/")?"faq.html":"landing-page/faq.html"}insertFooter(){const e=document.getElementById("footer-container");e?e.innerHTML=this.generateFooter():console.warn('Footer container not found. Add <div id="footer-container"></div> to your page.')}init(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{this.insertFooter()}):this.insertFooter()}}typeof module<"u"&&module.exports&&(module.exports=a);typeof window<"u"&&new a().init();export{n as S,a};
